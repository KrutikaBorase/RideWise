...
export default function MLPredictions() {
    ...
    const handleHourlyPredict = async () => {
        ...
        try {
            ...
            const rideCount = Math.round(response.predicted_rides || 0)
            ...
            setResult({
                type: 'Error',
                title: '⚠️ Prediction Unavailable',
                value: 'Error',
                explanation: `Unable to get prediction: ${error.message || 'Please check your connection and try again. Make sure the backend server is running on http://localhost:5000'}`,
                unit: ''
            })
        } finally {
            setLoading(false)
        ...
        <div className="flex min-h-screen">
            ...
            <PageWrapper showVehicles={true}>
                    ...
                    <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-2">
                        ...
                        {weatherData && weatherData.real && (
                            <motion.div 
                                ...
                                className="mt-4 inline-flex items-center gap-3 px-4 py-2 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-950/30 dark:to-cyan-950/30 shadow-sm rounded-full"
                            >
                ...
                <motion.div
                    ...
                    className="bg-card rounded-2xl shadow-lg p-3 md:p-4"
                >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                    ...
                    <AnimatePresence mode="wait">
                        <motion.div
                            ...
                            className="bg-card rounded-2xl shadow-lg p-4 md:p-6"
                        >
                        ...
                        {result ? (
                                ...
                                >
                                    ...
                                    {result.weatherImpact && (
                                        <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-xl shadow-sm">
                                            <div className="flex items-center justify-between">
                                                <div>
                                    ...
                                    {/* Model Info */}
                                    <div className="p-4 bg-gradient-to-r from-cyan-50 to-blue-50 dark:from-cyan-950/20 dark:to-blue-950/20 rounded-xl shadow-sm">
