                ...
                >
                    ...
                    <div className="flex gap-2">
                        ...
                        <button
                            ...
                            className={`px-4 py-2 rounded-xl ${theme === 'dark' ? 'bg-gray-700 text-white shadow-md' : 'bg-white shadow-md text-gray-900'} hover:shadow-lg transition-all flex items-center gap-2`}
                        >
                ...
                {!isTracking ? (
                    ...
                    >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="p-4 rounded-xl bg-blue-500/10 shadow-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            animate={{ opacity: 1, y: 0 }}
                            className={`${theme === 'dark' ? 'bg-card border-border' : 'bg-white border-slate-200'} rounded-xl p-6 shadow-md border`}
                        >
                            <div className="flex items-center justify-between mb-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className={`text-xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Tracking Active</h3>
                                        <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>Monitoring traffic conditions...</p>
                                    </div>
                                </div>
                                <button
                                    onClick={stopTracking}
                                    className="px-6 py-3 rounded-xl bg-red-50 dark:bg-red-500/10 text-red-600 dark:text-red-400 hover:shadow-md transition-all"
                                >
                                    Stop Tracking
                                </button>
                            </div>
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 shadow-sm">
                                    <div className="flex items-center gap-2 mb-2">
                                        <MapPin className="w-4 h-4 text-green-500" />
                                        <span className="text-gray-600 dark:text-gray-400 text-sm">From</span>
                                    </div>
                                    <p className="text-gray-900 dark:text-white font-medium">{currentRoute?.start_zone}</p>
                                </div>

                                <div className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 shadow-sm">
                                    <div className="flex items-center gap-2 mb-2">
                                        <Clock className="w-4 h-4 text-blue-500" />
                                        <span className="text-gray-600 dark:text-gray-400 text-sm">Est. Time</span>
                                    </div>
                                    <p className="text-gray-900 dark:text-white font-medium">{currentRoute?.estimated_time || '25'} min</p>
                                </div>
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <h2 className="text-xl font-bold text-gray-900 dark:text-white">Traffic Alerts</h2>
                                <button
                            ...
                            >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {alternativeRoutes.map((route, index) => (
                                        <div
                                            key={index}
                                            className="p-4 rounded-xl bg-gray-50 dark:bg-gray-700/50 shadow-sm hover:shadow-md transition-all cursor-pointer"
                                        >
                ...
                >
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Weather Impact</h3>
                        </div>
                        <div className="space-y-3">
                            <div className="flex items-center justify-between p-3 rounded-xl bg-white/5 dark:bg-white/5">
                                <div>
                                    <p className="text-gray-900 dark:text-white font-medium">Current Conditions</p>
                                    <p className="text-gray-600 dark:text-gray-400 text-sm">Clear skies, visibility good</p>
                                </div>
                                <span className="text-2xl">☀️</span>
                            </div>
                            <div className="grid grid-cols-3 gap-3 text-center">
                                <div className="p-3 rounded-xl bg-white/5">
                                    <p className="text-gray-600 dark:text-gray-400 text-xs mb-1">Temperature</p>
                                    <p className="text-gray-900 dark:text-white font-bold">24°C</p>
                                </div>
                                <div className="p-3 rounded-xl bg-white/5">
                                    <p className="text-gray-600 dark:text-gray-400 text-xs mb-1">Visibility</p>
                                    <p className="text-green-600 dark:text-green-400 font-bold">Good</p>
                                </div>
                                <div className="p-3 rounded-xl bg-white/5">
                                    <p className="text-gray-600 dark:text-gray-400 text-xs mb-1">Rain</p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-lg">
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <h3 className="text-lg font-bold text-gray-900 dark:text-white">Route Safety Score</h3>
                        </div>
                        <div className="space-y-3">
                            <div className="text-center p-4 rounded-xl bg-gradient-to-br from-green-500/20 to-emerald-500/20 shadow-sm">
                                <p className="text-4xl font-bold text-green-600 dark:text-green-400 mb-1">92/100</p>
                                <p className="text-gray-600 dark:text-gray-400 text-sm">ML-based accident risk analysis</p>
                            </div>
                ...
                {showARModal && (
                    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
                        ...
                        >
                            ...
                            <div className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-6 mb-4 shadow-sm">
                                <div className="flex items-center gap-3 mb-4">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                        ...
                                        <div className="text-lg font-bold text-gray-900 dark:text-white">12 mins</div>
                                    </div>
                                    <div className="p-3 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
                                        <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">Traffic</div>
                                        <div className="text-lg font-bold text-orange-600 dark:text-orange-400">Moderate</div>
                                    </div>
                                </div>
                            </div>

                            <div className="space-y-3">
                                <div className="p-4 bg-cyan-50 dark:bg-cyan-500/10 rounded-xl shadow-sm">
                                    <div className="flex items-start gap-3">
                                ...
                                <div className="p-4 bg-orange-50 dark:bg-orange-500/10 rounded-xl shadow-sm">
